...
import NgoApprovalForm from '../../components/NgoApprovalForm';
import { Link, Router } from '../../routes';
import web3 from '../../ethereum/web3';

class ShowNGOS extends Component {
  static async getInitialProps(props) {
    const ngo = fundRaiser(props.query.address);

    const summary = await ngo.methods.getSummary().call();
    const accounts = await web3.eth.getAccounts();
    const curr_account = accounts[0];
    const isApprover = await ngo.methods.approvers(curr_account.toString()).call();
  ...
  renderCards() {
    ...
    const items = [
      ...
      },
      {
        ...
        description:
          'The manager created this NGO and can create requests to withdraw money',
        extra: (
      ...
      },
      {
        ...
        description:
          'Total requests made by the manager. A request tries to withdraw money from the contract. Requests must be approved by approvers',
          extra: (
      ...
      },
      {
        ...
        description:
          'Number of people who have already funded to this NGO',
          extra: (
      ...
      },
      {
        ...
        description:
          'Total NGO balance left to spend.',
          extra: (
          ...
          <Grid.Row>
            ...
            <Card style={{overflowWrap: 'break-word'}} >
               <Card.Content>
                 ...
                 <Card.Description>
                   Displays your role in the NGO <strong>Manager/Approver</strong>
                 </Card.Description>
               </Card.Content>
               <Card.Content extra>
             ...
             <NgoApprovalForm address={this.props.address}/>
