...
class ShowProjects extends Component {
  static async getInitialProps(props) {
    const project = fundRaiser(props.query.address);

    const summary = await project.methods.getSummary().call();
    const accounts = await web3.eth.getAccounts();
    const curr_account = accounts[0];
    const isApprover = await project.methods.approvers(curr_account.toString()).call();
  ...
  renderCards() {
    ...
    const items = [
      ...
      },
      {
        ...
        description:
          'Number of people who have already funded to this project',
          extra: (
      ...
      },
      {
        ...
        description:
          'Total project balance left to spend.',
          extra: (
          ...
          <Grid.Row>
            ...
            <Card style={{overflowWrap: 'break-word'}} >
               <Card.Content>
                 ...
                 <Card.Description>
                   Displays your role in the project <strong>Manager/Approver</strong>
                 </Card.Description>
               </Card.Content>
               <Card.Content extra>
             ...
             <ProjectApprovalForm address={this.props.address}/>
